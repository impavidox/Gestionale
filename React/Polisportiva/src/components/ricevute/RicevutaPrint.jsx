  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const response = await ricevutaService.sendRicevutaEmail({
        ...
        subject: isScheda ? 'Scheda Socio - Polisportiva comunale Rivoli' : `Ricevuta N° ${ricevutaData.nrRicevuta} - Polisportiva comunale Rivoli`,
        pdfBase64: pdfBase64,
        fileName: fileName,
        isScheda: isScheda,
    ...
    return `
      <div style="font-family: Arial, sans-serif; font-size: 12px; line-height: 1.4; color: #000;">
        ...
        <div style="display: flex; justify-content: space-between; margin-bottom: 30px;">
          <div style="flex: 1;">
            <img src="/headerpoliric.png" style="max-width: 200px;" alt="Centro Sportivo Orbassano">
          </div>
