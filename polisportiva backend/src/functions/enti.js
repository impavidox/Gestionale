...
async function handleCreateRicevutaEnti(context, ricevutaData) {
    try {
        ...
        try {
            ...
            const insertQuery = `
                INSERT INTO ricevuteEntiRivoli (
...
async function handleUpdateRicevutaEnti(context, ricevutaData) {
    try {
        ...
        try {
            ...
            const checkQuery = `SELECT id FROM ricevuteEntiRivoli WHERE id = @ricevutaId`;
...
async function handleDeleteRicevutaEnti(context, deleteData) {
    try {
        ...
        const deleteQuery = `DELETE FROM ricevuteEntiRivoli WHERE id = @ricevutaId`;
